  ...
  return (
    <section id="services" className="relative py-16 sm:py-20 lg:py-24 bg-white">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden">
        <svg className="relative block w-full h-16 sm:h-20 md:h-32 rotate-180" viewBox="0 0 1200 120" preserveAspectRatio="none">
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2">
                <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-accent rounded-full flex items-center justify-center">
                      <div className="w-5 h-5 sm:w-6 sm:h-6 bg-pool-blue rounded-full"></div>
                    </div>
                  </div>
                </div>
